...
Vector3 Vector3::Projection(const Vector3& rhs) const
{
	...
	return (this->Dot(rhsNormalized) * rhsNormalized);
...
/*!
\brief
Returns a copy of this vector, rotated around an angle.
...
*/
/******************************************************************************/
Vector3 Vector3::RotateAroundAxis(float theta, const Vector3& axis)
{

	return ((*this)*cos(DegreeToRadian(theta)) + (*this).Dot(axis)*axis*(1.0f - cos(DegreeToRadian(theta))) + axis.Cross(*this)*sin(DegreeToRadian(theta)));
