...
void SceneSample::InitSpriteAnimations() {
	...
	spriteAnimationList[SPRITE_PLAYER]->animation->Set(0, 3, 0, 5.f, true);

}

void SceneSample::InitPlayer() {
...
void SceneSample::Update(const double& deltaTime) {
...
void SceneSample::RenderTileMap() {
...
void SceneSample::RenderPlayer() {
	...
	RenderSpriteAnimation(spriteAnimationList[SPRITE_PLAYER]);
	modelStack.PopMatrix();

}

void SceneSample::RenderText() {
...
void SceneSample::RenderBackground()
{
